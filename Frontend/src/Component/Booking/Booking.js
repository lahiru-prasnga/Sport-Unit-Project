        ...
        <div className={Book_css.left_event}>
          <label>
            ...
            <Select
              ...
              placeholder="select"
            >
              <MenuItem style={{ color: "black", width: "300px" }}>
                Select facility
              </MenuItem>
          ...
          <label>
            ...
            <TextField
              ...
              // onClick={() => handleFieldClick("Name with Initials")}
              name="name"
              fullWidth
              required
              autoComplete="true"
          ...
          <label>
            ...
            <input
              ...
              multiple
              onChange={handleFileChange}
              onClick={() => handleFieldClick("Permission Letter")}
              name="img"
            />
          </label>
          <br />
          ...
          <div className={Book_css.content}>
            <form onSubmit={handleSubmit}>
              <div className={Book_css.header}>
                <h2>Let's Make Your Reservation </h2>
              </div>
