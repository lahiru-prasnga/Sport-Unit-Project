...
const Booking = () => {
  ...
  const requiredFields = ["userID", "userNIC", "organizationName", "organizationAddress", "designation", "facility", "bookingDate", "Time", "status", "description", "facilityId"];
    ...
    <div className={Book_css.type01}>
      <form  >
        <div className={Book_css.left_event}>
          ...
          <label> 
            User NIC :
            <TextField id="filled-basic" variant="filled"  size="small"  value={applicantData.userNIC} fullWidth  required readOnly />  <br />
          </label>
